var variables = require("./wdio.variables");
...
exports.config = {
    ...
    reporters: ["spec", ["cucumberjs-json", { jsonFolder: variables.jsonReportFolder }]],
    reporterOptions: {
    junit: {
...
if (process.env.VSCODE_DEBUG_MODE) {
    ...
    exports.config.execArgv = ["--inspect=127.0.0.1:5859"];
}
